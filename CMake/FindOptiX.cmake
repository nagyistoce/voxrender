...
set(OptiX_INSTALL_DIR "C:/Program Files/NVIDIA Corporation/OptiX SDK 3.0.0/bin" CACHE PATH "Path to OptiX installed location.")
...
macro(OPTIX_find_api_library name version)
  ...
  if(WIN32)
    find_file(${name}_DLL
      NAMES ${name}.${version}.dll ${name}
	  PATH_SUFFIXES /bin${bit_dest}/
